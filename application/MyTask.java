...
public class MyTask extends RoboticsAPIApplication
{
    private LBR _lbr; 
    ...
    public void initialize()
    {
		...
		mff= new MediaFlangeFunctions(kuka_Sunrise_Cabinet_1,_lbr);
		svr=new StateVariablesOfRobot( _lbr);
		ptpm=new PTPmotionClass(_lbr,kuka_Sunrise_Cabinet_1);
	...
	public void onApplicationStateChanged(RoboticsAPIApplicationState state){
		...
		boolean running = state != RoboticsAPIApplicationState.MOTIONPAUSING;
